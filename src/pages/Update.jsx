...
const Update = () => {
    ...
    const serviceHandler = async e => {
        ...
        try{
            const { data }=await axios.put(`${import.meta.env.VITE_API_URL}/service/${_id}`,beautyService)
            console.log(data)
                        ...
                        <form onSubmit={serviceHandler}>
                            ...
                            <div className="md:flex gap-5">
                                <div className="form-control md:w-1/2 ">
                                    ...
                                    <label className="input-group">
                                        ...
                                        defaultValue={service_name} className="input input-bordered w-full border-pink-200" placeholder="service_name" />
                                    </label>
                                ...
                                <div className="form-control md:w-1/2 ">
                                    ...
                                    <label className="input-group">
                                        ...
                                        className="input input-bordered w-full border-pink-200" placeholder="service_price" />
                                    </label>
                            ...
                            <div className="form-control md:w-full ">
                                ...
                                <label className="input-group">
                                    ...
                                    className="input input-bordered w-full border-pink-200" placeholder="service_image" />
                                </label>
                            ...
                            <input type="submit" value="Update" className="btn btn-block mt-5 bg-white hover:bg-pink-50 hover:text-pink-600 font-bold hover:text-xl border-pink-200" />
